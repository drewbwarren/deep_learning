...
class Setup:
    ...
    def fit(self,**kwargs):
        ...
        self.max_its = 500; self.alpha_choice = 10**(-1);
        self.w_init = self.initializer()
        self.version = None; self.momentum = False; self.beta = 0;
        ...
        weight_history, cost_history = optimizers.gradient_descent(self.cost,self.alpha_choice,self.max_its,self.w_init,self.version,self.momentum,self.beta)
